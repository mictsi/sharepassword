...
public sealed class DbLocalUserService : ILocalUserService
{
    ...
    private async Task<bool> WouldRemoveLastEnabledAdminAsync(SekuraDbContext dbContext, LocalUser user, IReadOnlyCollection<string> resultingRoles, bool resultingDisabled, CancellationToken cancellationToken)
    {
