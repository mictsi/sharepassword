...
public class PasskeyOptions
{
    ...
    /// <summary>
    /// WebAuthn relying-party ID: the site's registrable domain (e.g. "sharepassword.example.com").
    ...
    public string ServerName { get; set; } = "SharePassword";

    /// <summary>Allowed web origins, e.g. "https://sharepassword.example.com".</summary>
